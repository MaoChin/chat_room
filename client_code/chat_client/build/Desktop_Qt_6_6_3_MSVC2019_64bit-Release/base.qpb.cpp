...
void UserInfo::setPersonSignature(const QString &personSignature)
{
    if (dptr->m_personSignature != personSignature) {
        dptr.detach();
        dptr->m_personSignature = personSignature;
    }
}
...
void UserInfo::setHeadPortrait(const QByteArray &headPortrait)
{
...
static constexpr struct {
    ...
    // uint_data
    {
        ...
        4, /* = headPortrait */
        // Field flags:
        QtProtobufPrivate::NoFlags, /* = singleChatFriendId */
...
MessageInfo &ChatSessionInfo::prevMessage() const
{
    return *dptr->m_prevMessage;
}

QByteArray ChatSessionInfo::headPortrait() const
{
    return dptr->m_headPortrait;
}
...
{
    if (dptr->m_singleChatFriendId != singleChatFriendId) {
        dptr.detach();
...
void ChatSessionInfo::setHeadPortrait(const QByteArray &headPortrait)
{
    if (dptr->m_headPortrait != headPortrait) {
        dptr.detach();
        dptr->m_headPortrait = headPortrait;
...
static constexpr struct {
    ...
    const char qt_protobuf_StringMessageInfo_char_data[41];
    ...
    // char_data
    /* metadata char_data: */
    "my_chat_proto.StringMessageInfo\0" /* = full message name */
    /* field char_data: */
    "content\0"
};
...
static constexpr struct {
    ...
    // uint_data
    {
        ...
        QtProtobufPrivate::NoFlags, /* = imageContent */
    },
    // char_data
    /* metadata char_data: */
...
{
    if (dptr->m_imageContent != imageContent) {
        dptr.detach();
...
static constexpr struct {
    ...
    const char qt_protobuf_SpeechMessageInfo_char_data[53];
    ...
    // char_data
    /* metadata char_data: */
    "my_chat_proto.SpeechMessageInfo\0" /* = full message name */
    /* field char_data: */
...
static constexpr struct {
    ...
    const char qt_protobuf_MessageContent_char_data[95];
...
UserInfo &MessageInfo::sender() const
{
...
MessageContent &MessageInfo::message() const
{
...
MessageInfo &Message::message() const
{
    return *dptr->m_message;
}
