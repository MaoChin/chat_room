...
#include "mysqlChatSessionMember.hpp" // mysql数据管理客户端封装
#include "mysqlChatSession.hpp"        // mysql数据管理客户端封装
#include "mysqlRelation.hpp"            // mysql数据管理客户端封装
#include "mysqlFriendApply.hpp"               // mysql数据管理客户端封装
...
namespace my_chat
{
  class FriendServiceImpl : public my_chat::FriendService
  {
  public:
    FriendServiceImpl(
    ...
    virtual void GetFriendList(::google::protobuf::RpcController *controller,
                               const ::my_chat::GetFriendListReq *request,
                               ::my_chat::GetFriendListRsp *response,
                              ...
                              ::google::protobuf::Closure *done)
    {
      ...
      std::string rid = request->request_id();
      std::string uid = request->user_id();
      std::string pid = request->friend_id();
      // 2. 从好友关系表中删除好友关系信息
    ...
    virtual void FriendAdd(::google::protobuf::RpcController *controller,
                           const ::my_chat::FriendAddReq *request,
                           ::my_chat::FriendAddRsp *response,
                           ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      // 1. 定义错误回调
    ...
    virtual void FriendAddProcess(::google::protobuf::RpcController *controller,
                                  const ::my_chat::FriendAddProcessReq *request,
                                  ::my_chat::FriendAddProcessRsp *response,
                                  ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      // 1. 定义错误回调
    ...
    virtual void UserSearch(::google::protobuf::RpcController *controller,
                              const ::my_chat::UserSearchReq *request,
                              ::my_chat::UserSearchRsp *response,
                              ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      // 1. 定义错误回调
    ...
    virtual void GetPendingFriendEventList(::google::protobuf::RpcController *controller,
                                           const ::my_chat::GetPendingFriendEventListReq *request,
                                           ::my_chat::GetPendingFriendEventListRsp *response,
                                           ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      // 1. 定义错误回调
    ...
    virtual void GetChatSessionList(::google::protobuf::RpcController *controller,
                                    const ::my_chat::GetChatSessionListReq *request,
                                    ::my_chat::GetChatSessionListRsp *response,
                                    ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      // 1. 定义错误回调
      ...
      for (const auto &f : sf_list)
      {
        ...
        chat_session_info->set_chat_session_name(user_list[f.friend_id].nick_name());
        chat_session_info->set_head_portrait(user_list[f.friend_id].head_portrait());
        MessageInfo msg;
    ...
    virtual void ChatSessionCreate(::google::protobuf::RpcController *controller,
                                   const ::my_chat::ChatSessionCreateReq *request,
                                   ::my_chat::ChatSessionCreateRsp *response,
                                   ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      // 1. 定义错误回调
    ...
    virtual void GetChatSessionMember(::google::protobuf::RpcController *controller,
                                      const ::my_chat::GetChatSessionMemberReq *request,
                                      ::my_chat::GetChatSessionMemberRsp *response,
                                      ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      // 1. 定义错误回调
