...
DEFINE_string(voice_service, "/service/voice_service", "语音识别子服务名称");
...
int main(int argc, char *argv[])
{
    ...
    my_chat::GatewayServerBuilder gsb;
    ...
    gsb.make_discovery_object(FLAGS_registry_host, FLAGS_base_service, FLAGS_file_service,
                              FLAGS_voice_service, FLAGS_message_service, FLAGS_friend_service,
