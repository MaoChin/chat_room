...
DEFINE_string(mysql_pswd, "root", "Mysql服务器访问密码");
DEFINE_string(mysql_db, "my_chat", "Mysql默认库名称");
...
DEFINE_string(mq_pswd, "root", "消息队列服务器访问密码");
...
int main(int argc, char *argv[])
{
    ...
    my_chat::transmitServerBuilder tsb;
