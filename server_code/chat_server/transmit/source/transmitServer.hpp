...
#include "channel.hpp"
#include "util.hpp"
#include "mysqlChatSessionMember.hpp"
...
namespace my_chat
{
  class transmitServiceImpl : public my_chat::MsgTransmitService
  {
  public:
    ...
    void GetTransmitTarget(google::protobuf::RpcController *controller,
                           const ::my_chat::NewMessageReq *request,
                           ::my_chat::GetTransmitTargetRsp *response,
