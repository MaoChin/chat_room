...
namespace my_chat
{
  ...
  public:
    ...
    void GetSingleFile(google::protobuf::RpcController *controller,
                       const ::my_chat::GetSingleFileReq *request,
                       ::my_chat::GetSingleFileRsp *response,
    ...
    void GetMultiFile(google::protobuf::RpcController *controller,
                      const ::my_chat::GetMultiFileReq *request,
                      ::my_chat::GetMultiFileRsp *response,
                      ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      response->set_request_id(request->request_id());
    ...
    void PutSingleFile(google::protobuf::RpcController *controller,
                       const ::my_chat::PutSingleFileReq *request,
                       ::my_chat::PutSingleFileRsp *response,
                       ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      response->set_request_id(request->request_id());
    ...
    void PutMultiFile(google::protobuf::RpcController *controller,
                      const ::my_chat::PutMultiFileReq *request,
                      ::my_chat::PutMultiFileRsp *response,
                      ::google::protobuf::Closure *done)
    {
      brpc::ClosureGuard rpc_guard(done);
      response->set_request_id(request->request_id());
      for (int i = 0; i < request->file_data_size(); i++)
      {
        ...
        my_chat::FileMessageInfo *info = response->add_file_info();
